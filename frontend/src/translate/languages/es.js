  ...
  es: {
    translations: {
      ...
      contacts: {
        ...
        labelsColumnHint:
          "Etiquetas visuales del contacto (independientes de las tags de automatización).",
        tagFilterHelp:
        ...
        assignments: {
          ...
          hint: "Seleccione los usuarios que pueden ver y atender este contacto. Se requiere al menos un responsable.",
          fieldLabel: "Responsables",
          fieldPlaceholder: "Buscar usuario…",
          manage: "Gestionar responsables",
          save: "Guardar",
          cancel: "Cancelar",
          saved: "Responsables actualizados.",
          requiresOne: "El contacto debe tener al menos un responsable.",
        },
      },
      contactLabelsManage: {
        title: "Etiquetas de contacto",
        subtitle: "Organice las etiquetas usadas en las atenciones.",
        newLabel: "Nueva etiqueta",
        search: "Buscar por nombre o descripción",
        stats: {
          total: "Total de etiquetas",
          used: "Etiquetas en uso",
          contactsTagged: "Contactos etiquetados",
          unused: "Etiquetas sin uso",
        },
        filter: {
          label: "Filtro",
          all: "Todas",
        ...
        delete: {
          ...
          usedBy:
            "La etiqueta «{{name}}» está aplicada en {{count}} contacto(s).",
          confirmUnused: "¿Eliminar la etiqueta «{{name}}»?",
          modeRemove: "Quitar de los contactos",
          modeReplace: "Sustituir por otra etiqueta",
          replaceWith: "Sustituir por",
          confirm: "Eliminar",
        },
        lastUsedNever: "Nunca usada",
        lastUsedAgo: "Usada hace {{time}}",
        empty: {
          title: "Sin etiquetas",
          subtitle: "Cree la primera etiqueta para organizar contactos.",
        },
        toasts: {
      ...
      contactLabels: {
        ...
        toasts: {
          created: "Etiqueta creada",
          saved: "Etiquetas del contacto guardadas",
        },
      },
      contactImportModal: {
      ...
      contactModal: {
        ...
        form: {
          ...
          assigneesHint:
            "Los administradores pueden definir qué usuarios tendrán acceso a este contacto.",
        },
        formErrors: {
          name: {
            required: "El nombre es obligatorio",
      ...
      globalNotifications: {
        whatsappTitle: "Nuevo mensaje en atención",
        internalChatTitle: "Nuevo mensaje interno",
        unknownContact: "Contacto",
        open: "Abrir",
        markAllRead: "Marcar todas como leídas",
        unreadCount: "{{count}} sin leer",
        noUnread: "Ninguna notificación pendiente",
      },
      notificationCenter: {
        title: "Notificaciones",
        empty: "Estás al día",
        showMore: "Mostrar más",
        limitHint: "Mostrando las últimas 50 notificaciones",
        tabs: {
          all: "Todas",
          whatsapp: "WhatsApp",
          internal: "Interno",
        ...
        sections: {
          internal: "Conversaciones internas",
          whatsapp: "Atención",
        },
      },
      notificationSound: {
        ariaLabel: "Volumen de notificaciones",
        popoverTitle: "Volumen de alertas de atención",
        openSettings: "Abrir configuración de volumen",
        mute: "Silenciar alertas",
        unmute: "Activar sonidos",
        testSound: "Probar sonido",
        toastMuted: "Notificaciones silenciadas",
        toastUnmuted: "Notificaciones activadas",
        openConversation: "Sonido de conversación abierta",
        openConversationHint:
          "Reproduce un sonido discreto cuando llegan mensajes en la conversación que ya estás viendo.",
      },
      ...
      settings: {
        ...
        whatsappBehavior: {
          ...
          mixedValuesHint:
            "Las conexiones seleccionadas tienen configuraciones diferentes. Al guardar, se aplicará el mismo valor a todas.",
          saveAppliesHint:
      ...
      backendErrors: {
        ...
        ERR_INVALID_LABEL_IDS:
          "Una o más etiquetas no son válidas o no pertenecen a su empresa.",
        ERR_CONTACT_LABEL_RELATIONS_TABLE_MISSING:
          "La asignación de etiquetas no está disponible. Ejecute las migraciones del backend (ContactLabelRelations).",
